...
Ext.define("Wms.view.framework.log.operatelog.OperateLogSearch",{
    extend:"Ext.form.Panel",
    alias:"widget.operateLogSearch",
    stores: ["framework.log.OperateLogListStore"],
    layout: 'form',
    bodyPadding: '5 5 0',
    fieldDefaults: {
        labelAlign: 'top',
                    ...
                    //提交按钮
                    {
                        ...
                        handler:function(){
                            ...
                            if(this.up('form').getForm().isValid()){
                                 var listStore=Ext.StoreManager.lookup("framework.log.OperateLogListStore");
